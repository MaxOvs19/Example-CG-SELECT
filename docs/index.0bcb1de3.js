...
(()=>{
    ...
    var Me = (t, e, n, r)=>{
        if (e && typeof e == "object" || typeof e == "function") for (let i of Ce(e))!Re.call(t, i) && i !== n && ae(t, i, {
            get: ()=>e[i],
            enumerable: !(r = Pe(e, i)) || r.enumerable
        });
        return t;
    };
    var De = (t, e, n)=>(n = t != null ? Qe(Oe(t)) : {}, Me(e || !t || !t.__esModule ? ae(n, "default", {
            value: t,
            enumerable: !0
        }) : n, t));
    var de = _e((ce, he)=>{
        (function() {
            ...
            t.tokenizer = function(e, n) {
                ...
                if (Array.isArray(e)) return e.map(function(m) {
                    ...
                    if (u.match(t.tokenizer.separator) || o == i) {
                        if (l > 0) {
                            ...
                            h.position = [
                                a,
                                l
                            ], h.index = s.length, s.push(new t.Token(r.slice(a, o), h));
                        }
                        a = o + 1;
                    }
                }
            ...
            t.Pipeline = function() {
                this._stack = [];
            }, t.Pipeline.registeredFunctions = Object.create(null), t.Pipeline.registerFunction = function(e, n) {
...
`, e);
            ...
            t.Vector = function(e) {
                ...
                for(var n = 0, r = this.elements.length / 2, i = r - n, s = Math.floor(i / 2), o = this.elements[s * 2]; i > 1 && (o < e && (n = s), o > e && (r = s), o != e);)i = r - n, s = n + Math.floor(i / 2), o = this.elements[s * 2];
                ...
                for(var n = 0, r = this.elements, i = e.elements, s = r.length, o = i.length, a = 0, u = 0, l = 0, h = 0; l < s && h < o;)a = r[l], u = i[h], a < u ? l += 2 : a > u ? h += 2 : a == u && (n += r[l + 1] * i[h + 1], l += 2, h += 2);
                return n;
            ...
            t.stemmer = function() {
                var e = {
                    ...
                    ful: "",
                    ness: ""
                }, r = "[^aeiou]", i = "[aeiouy]", s = r + "[^aeiouy]*", o = i + "[aeiou]*", a = "^(" + s + ")?" + o + s, u = "^(" + s + ")?" + o + s + "(" + o + ")?$", l = "^(" + s + ")?" + o + s + o + s, h = "^(" + s + ")?" + i, m = new RegExp(a), v = new RegExp(l), b = new RegExp(u), y = new RegExp(h), E = /^(.+?)(ss|i)es$/, p = /^(.+?)([^s])s$/, f = /^(.+?)eed$/, S = /^(.+?)(ed|ing)$/, w = /.$/, k = /(at|bl|iz)$/, _ = new RegExp("([^aeiouylsz])\\1$"), z = new RegExp("^" + s + i + "[^aeiouwxy]$"), H = /^(.+?[^aeiou])y$/, q = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, $ = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, V = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/, W = /^(.+?)(s|t)(ion)$/, P = /^(.+?)e$/, U = /ll$/, G = new RegExp("^" + s + i + "[^aeiouwxy]$"), N = function(c) {
                    var g, C, T, d, x, O, D;
                    if (c.length < 3) return c;
                    if (T = c.substr(0, 1), T == "y" && (c = T.toUpperCase() + c.substr(1)), d = E, x = p, d.test(c) ? c = c.replace(d, "$1$2") : x.test(c) && (c = c.replace(x, "$1$2")), d = f, x = S, d.test(c)) {
                        var L = d.exec(c);
                        d = m, d.test(L[1]) && (d = w, c = c.replace(d, ""));
                    } else if (x.test(c)) {
                        var L = x.exec(c);
                        g = L[1], x = y, x.test(g) && (c = g, x = k, O = _, D = z, x.test(c) ? c = c + "e" : O.test(c) ? (d = w, c = c.replace(d, "")) : D.test(c) && (c = c + "e"));
                    }
                    if (d = H, d.test(c)) {
                        var L = d.exec(c);
                        g = L[1], c = g + "i";
                    ...
                    return d = U, x = v, d.test(c) && x.test(c) && (d = w, c = c.replace(d, "")), T == "y" && (c = T.toLowerCase() + c.substr(1)), c;
                };
                return function(M) {
                    return M.update(N);
                };
            ...
            t.TokenSet = function() {
                ...
                for(var r = new t.TokenSet, i = [
                    ...
                    if (s.editsRemaining != 0) {
                        ...
                        if (s.str.length == 0 && (u.final = !0), i.push({
                            ...
                            s.str.length == 1 && (l.final = !0), i.push({
                                node: l,
                                editsRemaining: s.editsRemaining - 1,
                                str: s.str.slice(1)
                            });
                        ...
                        if (s.str.length > 1) {
                            ...
                            m in s.node.edges ? v = s.node.edges[m] : (v = new t.TokenSet, s.node.edges[m] = v), s.str.length == 1 && (v.final = !0), i.push({
                                node: v,
                                editsRemaining: s.editsRemaining - 1,
                                str: h + s.str.slice(2)
                            });
                ...
                for(var n = new t.TokenSet, r = void 0, i = [
                    {
                        qNode: e,
                        output: n,
                        node: this
                    ...
                    r = i.pop();
                    for(var s = Object.keys(r.qNode.edges), o = s.length, a = Object.keys(r.node.edges), u = a.length, l = 0; l < o; l++)for(var h = s[l], m = 0; m < u; m++){
                        var v = a[m];
                        if (v == h || h == "*") {
                            var b = r.node.edges[v], y = r.qNode.edges[h], E = b.final && y.final, p = void 0;
                            v in r.output.edges ? (p = r.output.edges[v], p.final = p.final || E) : (p = new t.TokenSet, p.final = E, r.output.edges[v] = p), i.push({
                                qNode: y,
                                output: p,
                                node: b
                            });
            ...
            t.Index = function(e) {
                ...
                for(var n = new t.Query(this.fields), r = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), u = 0; u < this.fields.length; u++)i[this.fields[u]] = new t.Vector;
                e.call(n, n);
                for(var u = 0; u < n.clauses.length; u++){
                    var l = n.clauses[u], h = null, m = t.Set.empty;
                    l.usePipeline ? h = this.pipeline.runString(l.term, {
                        fields: l.fields
                    }) : h = [
                        l.term
                    ];
                    for(var v = 0; v < h.length; v++){
                        ...
                        for(var S = 0; S < E.length; S++)for(var w = E[S], k = this.invertedIndex[w], _ = k._index, p = 0; p < l.fields.length; p++){
                            var f = l.fields[p], z = k[f], H = Object.keys(z), q = w + "/" + f, $ = new t.Set(H);
                            if (l.presence == t.Query.presence.REQUIRED && (m = m.union($), o[f] === void 0 && (o[f] = t.Set.complete)), l.presence == t.Query.presence.PROHIBITED) {
                                a[f] === void 0 && (a[f] = t.Set.empty), a[f] = a[f].union($);
                                continue;
                            }
                            if (i[f].upsert(_, l.boost, function(Ie, ke) {
                                return Ie + ke;
                            }), !s[q]) {
                                for(var V = 0; V < H.length; V++){
                                    var W = H[V], P = new t.FieldRef(W, f), U = z[W], G;
                                    (G = r[P]) === void 0 ? r[P] = new t.MatchData(w, f, U) : G.add(w, f, U);
                                }
                                s[q] = !0;
                            }
                        }
                    }
                    if (l.presence === t.Query.presence.REQUIRED) for(var p = 0; p < l.fields.length; p++){
                        var f = l.fields[p];
                        o[f] = o[f].intersect(m);
                    }
                }
                ...
                var c = Object.keys(r), g = [], C = Object.create(null);
                if (n.isNegated()) {
                ...
                var n = {}, r = {}, i = e.fieldVectors, s = Object.create(null), o = e.invertedIndex, a = new t.TokenSet.Builder, u = t.Pipeline.load(e.pipeline);
            ...
            t.Builder = function() {
                ...
                for(var s = 0; s < i.length; s++){
                    var o = i[s], a = this._fields[o].extractor, u = a ? a(e) : e[o], l = this.tokenizer(u, {
                        fields: [
                            o
                        ]
                    }), h = this.pipeline.run(l), m = new t.FieldRef(r, o), v = Object.create(null);
                    ...
                    for(var b = 0; b < h.length; b++){
                        ...
                        if (v[y] == null && (v[y] = 0), v[y] += 1, this.invertedIndex[y] == null) {
                            ...
                            for(var p = 0; p < i.length; p++)E[i[p]] = Object.create(null);
                        ...
                        for(var f = 0; f < this.metadataWhitelist.length; f++){
                            var S = this.metadataWhitelist[f], w = y.metadata[S];
                            this.invertedIndex[y][o][r][S] == null && (this.invertedIndex[y][o][r][S] = []), this.invertedIndex[y][o][r][S].push(w);
                        }
                    }
                }
                ...
                for(var e = {}, n = Object.keys(this.fieldTermFrequencies), r = n.length, i = Object.create(null), s = 0; s < r; s++){
                    for(var o = t.FieldRef.fromString(n[s]), a = o.fieldName, u = this.fieldLengths[o], l = new t.Vector, h = this.fieldTermFrequencies[o], m = Object.keys(h), v = m.length, b = this._fields[a].boost || 1, y = this._documents[o.docRef].boost || 1, E = 0; E < v; E++){
                        var p = m[E], f = h[p], S = this.invertedIndex[p]._index, w, k, _;
                        i[p] === void 0 ? (w = t.idf(this.invertedIndex[p], this.documentCount), i[p] = w) : w = i[p], k = w * ((this._k1 + 1) * f) / (this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + f), k *= b, k *= y, _ = Math.round(k * 1e3) / 1e3, l.insert(S, _);
                    }
                    e[o] = l;
                }
                this.fieldVectors = e;
                ...
                typeof define == "function" && define.amd ? define(n) : typeof ce == "object" ? he.exports = n() : e.lunr = n();
            }(this, function() {
                return t;
            });
        })();
    ...
    var Y = class {
        constructor(){
            ...
            this.createComponents(document.body), this.ensureFocusedElementVisible(), window.addEventListener("hashchange", ()=>this.ensureFocusedElementVisible());
        }
        createComponents(e) {
            le.forEach((n)=>{
                e.querySelectorAll(n.selector).forEach((r)=>{
                    r.dataset.hasInstance || (new n.constructor({
                        el: r,
                        app: this
    ...
    var J = class {
        ...
        removeEventListener(e, n) {
            ...
            for(let i = 0, s = r.length; i < s; i++)if (r[i] === n) {
                r.splice(i, 1);
                return;
            }
        }
    ...
    var re = class extends J {
        constructor(){
            ...
            this.height = 0;
            this.showToolbar = !0;
            this.toolbar = document.querySelector(".tsd-page-toolbar"), this.navigation = document.querySelector(".col-menu"), window.addEventListener("scroll", ne(()=>this.onScroll(), 10)), window.addEventListener("resize", ne(()=>this.onResize(), 10)), this.searchInput = document.querySelector("#tsd-search input"), this.searchInput && this.searchInput.addEventListener("focus", ()=>{
        ...
        hideShowToolbar() {
            ...
            this.showToolbar = this.lastY >= this.scrollTop || this.scrollTop <= 0 || !!this.searchInput && this.searchInput === document.activeElement, n !== this.showToolbar && (this.toolbar.classList.toggle("tsd-page-toolbar--hide"), this.navigation?.classList.toggle("col-menu--hide")), this.lastY = this.scrollTop;
        }
    }, R = re;
    R.instance = new re;
    var X = class extends I {
        constructor(n){
            ...
            this.anchors = [];
            this.index = -1;
            R.instance.addEventListener("resize", ()=>this.onResize()), R.instance.addEventListener("scroll", (r)=>this.onScroll(r)), this.createAnchors();
        }
        createAnchors() {
            let n = window.location.href;
            n.indexOf("#") != -1 && (n = n.substring(0, n.indexOf("#"))), this.el.querySelectorAll("a").forEach((r)=>{
                let i = r.href;
                if (i.indexOf("#") == -1 || i.substring(0, n.length) != n) return;
                let s = i.substring(i.indexOf("#") + 1), o = document.querySelector("a.tsd-anchor[name=" + s + "]"), a = r.parentNode;
                !o || !a || this.anchors.push({
                    link: a,
                    anchor: o,
                    position: 0
                });
        ...
        onResize() {
            ...
            let r = new CustomEvent("scroll", {
                detail: {
                    scrollTop: R.instance.scrollTop
                }
            });
            this.onScroll(r);
        }
        onScroll(n) {
            let r = n.detail.scrollTop + 5, i = this.anchors, s = i.length - 1, o = this.index;
            for(; o > -1 && i[o].position > r;)o -= 1;
            for(; o < s && i[o + 1].position < r;)o += 1;
            this.index != o && (this.index > -1 && this.anchors[this.index].link.classList.remove("focus"), this.index = o, this.index > -1 && this.anchors[this.index].link.classList.add("focus"));
        }
    };
    var ue = (t, e = 100)=>{
        let n;
    ...
    function ve() {
        ...
        t.classList.add("loading"), e && (e.addEventListener("error", ()=>{
        ...
        let n = document.querySelector("#tsd-search input"), r = document.querySelector("#tsd-search .results");
        if (!n || !r) throw new Error("The input field or the result list wrapper was not found");
        let i = !1;
        r.addEventListener("mousedown", ()=>i = !0), r.addEventListener("mouseup", ()=>{
            i = !1, t.classList.remove("has-focus");
        }), n.addEventListener("focus", ()=>t.classList.add("has-focus")), n.addEventListener("blur", ()=>{
    ...
    function Fe(t, e, n, r) {
        n.addEventListener("input", ue(()=>{
            He(t, e, n, r);
        }, 200));
        let i = !1;
        n.addEventListener("keydown", (s)=>{
            i = !0, s.key == "Enter" ? Ve(e, n) : s.key == "Escape" ? n.blur() : s.key == "ArrowUp" ? pe(e, -1) : s.key === "ArrowDown" ? pe(e, 1) : i = !1;
        }), n.addEventListener("keypress", (s)=>{
            i && s.preventDefault();
        }), document.body.addEventListener("keydown", (s)=>{
            s.altKey || s.ctrlKey || s.metaKey || !n.matches(":focus") && s.key === "/" && (n.focus(), s.preventDefault());
        });
    }
    function Ae(t, e) {
        t.index || window.searchData && (e.classList.remove("loading"), e.classList.add("ready"), t.data = window.searchData, t.index = me.Index.load(window.searchData.index));
    }
    function He(t, e, n, r) {
        if (Ae(r, t), !r.index || !r.data) return;
        e.textContent = "";
        let i = n.value.trim(), s = i ? r.index.search(`*${i}*`) : [];
        ...
        for(let o = 0, a = Math.min(10, s.length); o < a; o++){
            let u = r.data.rows[Number(s[o].ref)], l = fe(u.name, i);
            globalThis.DEBUG_SEARCH_WEIGHTS && (l += ` (score: ${s[o].score.toFixed(2)})`), u.parent && (l = `<span class="parent">${fe(u.parent, i)}.</span>${l}`);
    ...
    function pe(t, e) {
        ...
        if (!n) n = t.querySelector(e == 1 ? "li:first-child" : "li:last-child"), n && n.classList.add("current");
            ...
            let r = n;
            if (e === 1) do r = r.nextElementSibling ?? void 0;
            while (r instanceof HTMLElement && r.offsetParent == null);
            else do r = r.previousElementSibling ?? void 0;
            while (r instanceof HTMLElement && r.offsetParent == null);
    ...
    function fe(t, e) {
        ...
        for(; o != -1;)i.push(ie(t.substring(s, o)), `<b>${ie(t.substring(o, o + r.length))}</b>`), s = o + r.length, o = n.indexOf(r, s);
    ...
    var F = "mousedown", ye = "mousemove", j = "mouseup", Z = {
        x: 0,
        y: 0
    }, ge = !1, se = !1, Be = !1, A = !1, xe = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    document.documentElement.classList.add(xe ? "is-mobile" : "not-mobile");
    xe && "ontouchstart" in document.documentElement && (Be = !0, F = "touchstart", ye = "touchmove", j = "touchend");
    ...
    var K = class extends I {
        constructor(n){
            super(n);
            this.className = this.el.dataset.toggle || "", this.el.addEventListener(j, (r)=>this.onPointerUp(r)), this.el.addEventListener("click", (r)=>r.preventDefault()), document.addEventListener(F, (r)=>this.onDocumentPointerDown(r)), document.addEventListener(j, (r)=>this.onDocumentPointerUp(r));
        }
        setActive(n) {
            if (this.active == n) return;
            this.active = n, document.documentElement.classList.toggle("has-" + this.className, n), this.el.classList.toggle("active", n);
    ...
    var ee = class extends I {
        constructor(n){
            super(n);
            this.key = `filter-${this.el.name}`, this.value = this.el.checked, this.el.addEventListener("change", ()=>{
                this.setLocalStorage(this.el.checked);
            }), this.setLocalStorage(this.fromLocalStorage()), Le.innerHTML += `html:not(.${this.key}) .tsd-is-${this.el.name} { display: none; }
`;
        }
        fromLocalStorage() {
        ...
        handleValueChange() {
            this.el.checked = this.value, document.documentElement.classList.toggle(this.key, this.value), this.app.filterChanged(), document.querySelectorAll(".tsd-index-section").forEach((n)=>{
    ...
    var te = class extends I {
        constructor(n){
            super(n);
            this.calculateHeights(), this.summary = this.el.querySelector(".tsd-accordion-summary"), this.icon = this.summary.querySelector("svg"), this.key = `tsd-accordion-${this.summary.textContent.replace(/\s+/g, "-").toLowerCase()}`, this.setLocalStorage(this.fromLocalStorage(), !0), this.summary.addEventListener("click", (r)=>this.toggleVisibility(r)), this.icon.style.transform = this.getIconRotation();
        }
        getIconRotation(n = this.el.open) {
            return `rotate(${n ? 0 : -90}deg)`;
        }
        calculateHeights() {
            let n = this.el.open, { position: r , left: i  } = this.el.style;
            this.el.style.position = "fixed", this.el.style.left = "-9999px", this.el.open = !0, this.expandedHeight = this.el.offsetHeight + "px", this.el.open = !1, this.collapsedHeight = this.el.offsetHeight + "px", this.el.open = n, this.el.style.height = n ? this.expandedHeight : this.collapsedHeight, this.el.style.position = r, this.el.style.left = i;
        }
        toggleVisibility(n) {
            n.preventDefault(), this.el.style.overflow = "hidden", this.el.open ? this.collapse() : this.expand();
        }
        expand(n = !0) {
            this.el.open = !0, this.animate(this.collapsedHeight, this.expandedHeight, {
                opening: !0,
                duration: n ? 300 : 0
            });
        }
        ...
        animationEnd(n) {
            this.el.open = n, this.animation = void 0, this.el.style.height = "auto", this.el.style.overflow = "visible", this.setLocalStorage(n);
        }
        fromLocalStorage() {
            let n = Q.getItem(this.key);
        ...
        setLocalStorage(n, r = !1) {
            this.fromLocalStorage() === n && !r || (Q.setItem(this.key, n.toString()), this.el.open = n, this.handleValueChange(r));
        }
        handleValueChange(n = !1) {
            this.fromLocalStorage() === this.el.open && !n || (this.fromLocalStorage() ? this.expand(!1) : this.collapse(!1));
        }
    };
    function be(t) {
        let e = Q.getItem("tsd-theme") || "os";
        t.value = e, Ee(e), t.addEventListener("change", ()=>{
...
//# sourceMappingURL=index.0bcb1de3.js.map
